...
public class TelefonoToInvolucradoAssociation {
    ...
    private TelefonoSourceRelation parent;
    ...
    public TelefonoSourceRelation getParent(){
        return parent;
    }

    @JsonIgnore
    public void setParent(TelefonoSourceRelation parent){
        this.parent = parent;
    }
